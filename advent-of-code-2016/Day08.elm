...
type alias Grid =
    { width : Int, height : Int, pixels : Dict ( Int, Int ) Pixel }


type alias Model =
    { instructions : List Instruction, grid : Grid }
...
init =
    ( { instructions = lines input |> parseInstructions, grid = makeGrid 50 6 }, Cmd.none )
...
update =
    stepThrough processInstruction
